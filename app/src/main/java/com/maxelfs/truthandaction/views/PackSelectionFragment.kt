...
import com.maxelfs.truthandaction.databinding.FragmentPackSelectionBinding
import com.maxelfs.truthandaction.viewmodels.PackSelectionViewModel
import com.maxelfs.truthandaction.views.packs.PackAdapter
import com.maxelfs.truthandaction.views.packs.PackClickListener
...
class PackSelectionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _viewModel.appSelectToMarketThird.observe(viewLifecycleOwner) {
            if (it) {
                try {
                    val intent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.maxelfs.truthanddare"))
                    startActivity(intent)
                } catch (e: ActivityNotFoundException) {
                    val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.maxelfs.truthanddare"))
                    startActivity(intent)
                }
            }
        }
